...
from external.webhook.update_chat_title import update_title
...
def zoan_internal_search_uploaded_documents(
    ...
    filter: Annotated[Optional[dict], "Optional filter to narrow down search results, in JSON format, for example: {'object_key': 'flappy bird'}"] = None,
    ...
    Args:
        ...
        filter: Filter has keys that can be used to narrow down search:
